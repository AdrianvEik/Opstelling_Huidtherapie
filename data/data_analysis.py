...
pl1 = Default(OD_values[:6], OD_set1[:6], y_err=std[:6],data_label="ML8511 UV", colour="b", fx=fit_func, linestyle="",
...
pl11 = Default(OD_values[:8], OD_set1[:8], y_err=std[:8], data_label="Thorlabs sensor", colour="r", fx=fit_func, linestyle="",
              x_label="OD filter waarde", y_label="OD gemeten waarde", func_format="fit lin. gebied: y = {0}x", add_mode=True,
               capsize=5)
pl21 = Default(OD_values[8:], OD_set1[8:], y_err=std[8:], colour="r", linestyle="",
               add_mode=True, data_label="", capsize=5)
